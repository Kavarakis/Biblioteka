...
{
    class StudentMaster : Clanovi, Ipopust
    {
        private string indeks { get; set; }
        public StudentMaster(string ime, string prezime, DateTime datum, string jmbg,string indeks) : base(ime, prezime, datum, jmbg)
        {
            this.indeks = indeks;
        }
